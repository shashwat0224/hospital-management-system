...
def show_admin_dashboard():
    ...
    def manage_staff(parent_window):
        ...
        return_button = tk.Button(staff_management_window, text="Back to Main Menu",
                                  command=lambda: return_to_main_menu(staff_management_window))
        return_button.pack()
    ...
    def view_update_doctor_info(parent_window):
        ...
        def view_doctor_information():
            ...
            tree = ttk.Treeview(view_window,
                                columns=("ID", "Name", "Specialization", "Fees", "Contact", "Address", "Email"),
                                show="headings")
        ...
        view_info_button = tk.Button(doctor_info_window, text="View Doctor Information",
                                     command=view_doctor_information)
        view_info_button.pack()

        update_info_button = tk.Button(doctor_info_window, text="Update Doctor Information",
                                       command=update_doctor_information)
        update_info_button.pack()

        return_button = tk.Button(doctor_info_window, text="Back to Main Menu",
                                  command=lambda: return_to_main_menu(doctor_info_window))
        return_button.pack()
    ...
    def appointment_scheduling_notifications(parent_window):
        ...
        def show_appointments():
            ...
            back_button = tk.Button(all_appointments, text="Back", command=lambda: back(appointments_window))
            back_button.pack()
        ...
        schedule_appointment_button = tk.Button(appointment_schedule_window, text="Schedule Appointment",
                                                command=schedule_appointment)
        schedule_appointment_button.pack()

        show_appointments_button = tk.Button(appointment_schedule_window, text="Show All Appointments",
                                             command=show_appointments)
        show_appointments_button.pack()

        return_button = tk.Button(appointment_schedule_window, text="Back to Main Menu",
                                  command=lambda: return_to_main_menu(appointment_schedule_window))
        return_button.pack()
    ...
    manage_records_button = tk.Button(main_menu, text="Manage Patient Records",
                                      command=lambda: manage_patient_records(main_menu))
    ...
    view_update_doctor_info_button = tk.Button(main_menu, text="View/Update Doctor Information",
                                               command=lambda: view_update_doctor_info(main_menu))
    view_update_doctor_info_button.pack()

    appointment_scheduling_button = tk.Button(main_menu, text="Appointment Scheduling/Notifications",
                                              command=lambda: appointment_scheduling_notifications(main_menu))
